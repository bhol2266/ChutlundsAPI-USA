...
import { handleGetFullAlbum_IndianNudes } from "./utils";
...
export default async function handler(req, res) {
    ...
    try {
        ...
        const response = await axios.get(`https://www.nudeindians2.net/page/${page}/`, {
            headers: {
                "User-Agent":
        ...
        for (const element of posts) {
            ...
            const description = $(element).find("div.entry-summary").text().trim();
            ...
            const fullAlbumData = await handleGetFullAlbum_IndianNudes(original_fullalbum_href);
            if (!fullAlbumData) {
